...
While building this lab, I was experiencing some issues while integrating Nginx KIC to Nginx One Console. Thanks to Google Gemini ❤️❤️ to help found some reference and also the resolutions. This caveats might not be relevant when future updates was release, but it will help at least for current release version and for my lab! 🙂👍🏻
</br>
</br>
